...
local zoomParallax = {}
zoomParallax.name = "ExCameraDynamics/ZoomParticleParallax"
...
local fieldOrder = {
	...
	"minParticleScrollX", "maxParticleScrollX",
	"minParticleScrollY", "maxParticleScrollY",
...
local defaultData = {
	...
	minParticleScrollX = 0.0,
	maxParticleScrollX = 0.0,
	
	minParticleScrollY = 0.0,
	maxParticleScrollY = 0.0,
...
function zoomParallax.displayName(language, style)
    ...
    return string.format("Zoom Particle Parallax - %s", texture)
end
